...
export const getMensData = (obj) => (dispatch) => {
  ...
  axios
    .get("http://localhost:8000/products?category=mens", obj)
...
export const getWomensData = (obj) => (dispatch) => {
  ...
  axios
    .get(
      "http://localhost:8000/products?category=womens",
      obj
    )
    .then((res) =>
...
export const getMobileData = (obj) => (dispatch) => {
  ...
  axios
    .get(
      "http://localhost:8000/products?category=mobile_accessories",
      obj
    )
    .then((res) =>
...
export const getAllData = (query) => (dispatch) => {
  ...
  axios
    .get(
      `http://localhost:8000/products?q=${query}&_limit=20`
    )
